...
\begin{itemize}
    ...
    \item \texttt{interpolation.py}: \texttt{interp\_linear}, \texttt{interp\_bilinear}, \texttt{get\_lottery}, \texttt{spline\_fit}, \texttt{spline\_coef}, \texttt{spline\_eval}, \texttt{cheb\_nodes}, \texttt{cheb\_basis}, \texttt{cheb\_coef}, \texttt{cheb\_eval}
...
\begin{itemize}
    ...
    \item \texttt{forward.py}: \texttt{forward\_iteration}, \texttt{stationary\_distribution}, \texttt{expectation\_iteration}, \texttt{expectation\_functions}, \texttt{stationary\_markov}
