...
\begin{itemize}
    ...
    \item \texttt{solvers/*}: \texttt{GridVFI}, \texttt{HowardImprovement}, \texttt{PolicyFunctionIteration}, \texttt{EGM}, \texttt{CollocationVFI\_Spline}, \texttt{CollocationVFI\_Chebyshev}
    \item \texttt{ssj.py}: \texttt{jacobian}, \texttt{step1\_backward}, \texttt{J\_from\_F}
    \item \texttt{models/aiyagari.py}: \texttt{firm\_k\_demand}, \texttt{firm\_wage}, \texttt{solve\_steady\_state}
\end{itemize}
