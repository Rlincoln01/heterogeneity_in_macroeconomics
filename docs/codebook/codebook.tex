...
Policy functions are on the grid; use \texttt{interp\_linear} to evaluate at off-grid points. See \texttt{backward.py} and Macro Bible ``Value Function Iteration'' / ``Endogenous Grid Method''.
...
\subsection{Foundational Modules}
\begin{itemize}
    \item \texttt{grids.py}: \texttt{make\_asset\_grid}, \texttt{double\_exponential\_grid}, \texttt{log\_spaced\_grid}, \texttt{make\_grid\_1d}, \texttt{make\_grid\_nd}, \texttt{cartesian\_product}, \texttt{gridmake}, \texttt{tensor\_product}, \texttt{smolyak\_sparse\_grid}
    \item \texttt{quadrature.py}: \texttt{qnwlege}, \texttt{qnwcheb}, \texttt{qnwnorm}, \texttt{qnwlogn}, \texttt{qnwunif}, \texttt{qnwsimp}, \texttt{qnwtrap}, \texttt{qnwbeta}, \texttt{qnwgamma}, \texttt{qnwnorm\_mv}
    \item \texttt{interpolation.py}: \texttt{interp\_linear}, \texttt{interp\_bilinear}, \texttt{get\_lottery}, \texttt{spline\_fit}, \texttt{spline\_coef}, \texttt{spline\_eval}, \texttt{spline\_basis\_matrix}, \texttt{cubic\_basis\_matrix}, \texttt{linear\_basis\_matrix}, \texttt{tensor\_basis\_matrix}, \texttt{cheb\_nodes}, \texttt{cheb\_basis}, \texttt{cheb\_coef}, \texttt{cheb\_eval}
    ...
    \item \texttt{markov.py}: \texttt{rouwenhorst}, \texttt{tauchen}, \texttt{stationary\_distribution}, \texttt{simulate\_markov}
...
\begin{itemize}
    \item \texttt{backward.py}: \texttt{backward\_egm}, \texttt{backward\_vfi}, \texttt{policy\_iteration}
    \item \texttt{forward.py}: \texttt{forward\_iteration}, \texttt{stationary\_distribution}, \texttt{expectation\_iteration}, \texttt{expectation\_functions}, \texttt{stationary\_markov}, \texttt{stationary\_eigenvector}
    \item \texttt{steady\_state.py}: \texttt{household\_steady\_state}, \texttt{market\_clearing}
    \item \texttt{distributions.py}: \texttt{forward\_policy\_step}, \texttt{stationary\_distribution\_ha}, \texttt{lottery\_indices}
    \item \texttt{dp\_tools.py}: \texttt{solve\_policy\_egm}, \texttt{solve\_policy\_vfi}, \texttt{solve\_steady\_policy}
